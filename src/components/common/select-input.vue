  ...
  <div>
    ...
    <Listbox v-model="selectedValue" @update:model-value="$emit('update:modelValue', $event)">
      <div class="relative">
        ...
        <ListboxButton
          :class="[
            'w-full cursor-pointer rounded-lg bg-brand-50 border border-brand-200 px-4 text-left text-brand-600 placeholder:text-brand-300 focus:border-brand-500 focus:outline-none focus:ring focus:ring-brand-500/10',
