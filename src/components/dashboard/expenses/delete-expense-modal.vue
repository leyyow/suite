...
<template>
  <Modal :open="modelValue" size="md" centered @update:open="emit('update:modelValue', $event)">
    <div class="flex flex-col items-center justify-center gap-2 text-center">
      ...
      <p class="text-base font-medium">Do you want to delete this expense?</p>
      <p class="text-sm text-brand-400">
        This expense will be entirely removed from the list, and all its information will be erased.
      </p>
      <AppButton
